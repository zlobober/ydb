...
TBridgeQueryResult* BridgeRun(TBridgeYqlPlugin* plugin, const char* impersonationUser, const char* queryText)
{
    auto* nativePlugin = reinterpret_cast<IYqlPlugin*>(plugin);
    ...
    auto result = nativePlugin->Run(TString(impersonationUser), TString(queryText));
